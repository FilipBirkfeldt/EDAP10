			...
			while (true) {
				...
				if (m != null){	
					...
					while (m.getCommand() == WashingMessage.TEMP_SET) {
						...
						double levelTemp = reqTemp - 0.2*Settings.SPEEDUP*2000/(waterLevel * 4.184 * Math.pow(10, 3));
						//System.out.println(levelTemp +" + " +  (long) Math.multiplyExact(dt, Settings.SPEEDUP/1000));
